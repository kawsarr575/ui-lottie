<?php
    /* Template Name: Lottie Single Product */
...
<div class="nx-lottie-body">
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-6 offset-3">
                    <div class="nx-lottie-home-search">
                        ...
                        <input type="text" class="form-control" placeholder="Looking for something...?" aria-label="Text input with dropdown button">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row nx-lottie-after-hero-area">
            ...
            <div class="col-9">
                <div class="row">
                    <?php foreach( $controller->get_all_approved_product() as $data ): ?>
